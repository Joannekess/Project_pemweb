...
function registrasi($data)
{
    ...
    $result = mysqli_query($conn, "SELECT email FROM user3 WHERE email = '$username'");
    ...
    mysqli_query($conn, "INSERT INTO user3 VALUES ('', '$firstname', '$lastname', '$username', '$password', '$date', '$gender', '$pp')");
    return mysqli_affected_rows($conn);
}
